...
const useStore = create((set) => ({
  ...
  tipPercentage: 0.05,        setTipPercentage: (tipPercentage) => set(() =>  ({ tipPercentage })),
  tipValue: 50,               setTipValue: (tipValue) => set(() =>  ({ tipValue })),
  tipValueDialogOpen: false,  setTipValueDialogOpen: (tipValueDialogOpen) => set(() =>  ({ tipValueDialogOpen })),
...
export const useTipPercentage = () => useStore((state) => state.tipPercentage);
export const useSetTipPercentage = () => useStore((state) => state.setTipPercentage);
export const useTipValue = () => useStore((state) => state.tipValue);
export const useSetTipValue = () => useStore((state) => state.setTipValue);
export const useTipValueDialogOpen = () => useStore((state) => state.tipValueDialogOpen);
export const useSetTipValueDialogOpen = () => useStore((state) => state.setTipValueDialogOpen);
